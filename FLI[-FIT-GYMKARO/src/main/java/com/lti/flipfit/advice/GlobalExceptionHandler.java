...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCenterAlreadyExists(CenterAlreadyExistsException ex,
            WebRequest request) {
        ErrorResponse res = new ErrorResponse(
                LocalDateTime.now(),
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorResponse> handleCenterUpdateNotAllowed(CenterUpdateNotAllowedException ex,
            WebRequest request) {
        ErrorResponse res = new ErrorResponse(
                LocalDateTime.now(),
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorResponse> handleInvalidCenterLocation(InvalidCenterLocationException ex,
            WebRequest request) {
        ErrorResponse res = new ErrorResponse(
                LocalDateTime.now(),
                ex.getMessage(),
    ...
    public ResponseEntity<ErrorResponse> handleBookingAlreadyExists(BookingAlreadyExistsException ex,
            WebRequest request) {
        ErrorResponse res = new ErrorResponse(
                LocalDateTime.now(),
                ex.getMessage(),
